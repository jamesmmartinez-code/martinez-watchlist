...
func _process(delta: float) -> void:
	...
	if world_env and world_env.environment:
		...
		# 2026-05-07 jm-fix v2: fog 0.0009 peak made the world go WHITE (sky/sun
		# spill with nothing to soften it). Bumped to 0.0031 peak — roughly the
		# midpoint between "brown haze" (0.0042) and "white-out" (0.0009).
		e.fog_density = 0.0020 + dusk_w2 * 0.0008 + night_w2 * 0.0003
