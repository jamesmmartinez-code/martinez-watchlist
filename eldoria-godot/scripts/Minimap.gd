...
const LANDMARKS: Array = [
	# ── Briarwood Village core ────────────────────────────────────────────
	{"pos": Vector3(  0.0, 0.0,  0.0),  "name": "Briarwood Square",
	"kind": "village",  "color": Color(1.0, 0.847, 0.42),   "icon": "⌂",
	"asset": "stylized_bell_island_house_mound.fbx"},
	{"pos": Vector3(  0.0, 0.0,  6.0),  "name": "Stone Well",
	"kind": "well",     "color": Color(0.78, 0.85, 0.93),   "icon": "○",
	"asset": "stone_well.glb"},
	{"pos": Vector3(  0.0, 0.0, -2.0),  "name": "Village Campfire",
	"kind": "campfire", "color": Color(1.0, 0.604, 0.247),  "icon": "✺",
	"asset": "campfire.glb"},
	{"pos": Vector3(  0.0, 0.0,  22.0), "name": "Briarwood Town Hall",
	"kind": "village",  "color": Color(1.0, 0.847, 0.42),   "icon": "⌂",
	"asset": "tavern_troll.glb"},
	{"pos": Vector3( 10.0, 0.0,  0.0),  "name": "Market District",
	"kind": "village",  "color": Color(1.0, 0.847, 0.42),   "icon": "⌂",
	"asset": "stylized_wood_kiosk.fbx"},
	{"pos": Vector3(-10.0, 0.0,  0.0),  "name": "Crafting Quarter",
	"kind": "forge",    "color": Color(0.90, 0.55, 0.15),   "icon": "⚒",
	"asset": "stylized_forge_station.fbx"},
	{"pos": Vector3(  8.0, 0.0, -5.0),  "name": "Shrine of the Elder",
	"kind": "shrine",   "color": Color(0.78, 0.85, 0.93),   "icon": "✦",
	"asset": "stylized_bell_tower.fbx"},
	# ── Mid-world POIs (60-115m from origin) ─────────────────────────────
	{"pos": Vector3( 60.0, 0.0, -30.0), "name": "Ruined Watchtower",
	"kind": "camp",     "color": Color(0.70, 0.65, 0.55),   "icon": "△",
	"asset": "log_building.glb"},
	{"pos": Vector3(-55.0, 0.0,  45.0), "name": "Ancient Stone Circle",
	"kind": "shrine",   "color": Color(0.60, 0.75, 0.90),   "icon": "✦",
	"asset": "stylized_edged_rocks_set.fbx"},
	{"pos": Vector3(  0.0, 0.0, -80.0), "name": "Whispering Obelisk",
	"kind": "shrine",   "color": Color(0.80, 0.55, 0.90),   "icon": "✦",
	"asset": "PROCEDURAL"},
	{"pos": Vector3(-70.0, 0.0, -10.0), "name": "Collapsed Bridge",
	"kind": "camp",     "color": Color(0.65, 0.60, 0.50),   "icon": "△",
	"asset": "PROCEDURAL"},
	{"pos": Vector3( 45.0, 0.0,  65.0), "name": "Riverside Dock",
	"kind": "campfire", "color": Color(0.50, 0.65, 0.80),   "icon": "✺",
	"asset": "stylized_old_sea_dock.fbx"},
	{"pos": Vector3(-30.0, 0.0, -75.0), "name": "Hermit's Hut",
	"kind": "village",  "color": Color(0.75, 0.70, 0.55),   "icon": "⌂",
	"asset": "stylized_bell_island_house_mound.fbx"},
	# ── Goblin camps ──────────────────────────────────────────────────────
	...
	"asset": "PROCEDURAL"},
	# ── Crystal Caves ─────────────────────────────────────────────────────
	{"pos": Vector3(-50.0, 0.0, -40.0), "name": "Crystal Caves Entrance",
	"kind": "cave",     "color": Color(0.396, 0.875, 0.898),"icon": "❖",
	"asset": "PROCEDURAL (twin pillars + rune keystone)"},
	# ── Far-world landmarks (115-260m) ────────────────────────────────────
	{"pos": Vector3(  0.0, 0.0, -115.0),"name": "Barbarian Warband",
	"kind": "camp",     "color": Color(0.75, 0.25, 0.15),   "icon": "△",
	"asset": "bandit.glb (temp)"},
	{"pos": Vector3( 80.0, 0.0,   0.0), "name": "Untamed Wolves",
	"kind": "camp",     "color": Color(0.55, 0.30, 0.18),   "icon": "△",
	"asset": "goblin.glb (temp)"},
	{"pos": Vector3(-110.0, 0.0, -85.0),"name": "Castle Ruins — Outer Guard",
	"kind": "camp",     "color": Color(0.45, 0.42, 0.48),   "icon": "△",
	"asset": "bandit.glb (temp)"},
	{"pos": Vector3(-80.0, 0.0,-260.0), "name": "Ruined Castle of Doom",
	"kind": "boss",     "color": Color(0.486, 0.247, 0.690),"icon": "☠",
	"asset": "PROCEDURAL (keep + 3 towers + curtain walls)"},
	{"pos": Vector3(-160.0, 0.0,-160.0),"name": "The Imperator",
	"kind": "boss",     "color": Color(0.486, 0.247, 0.690),"icon": "☠",
	"asset": "bandit.glb (temp)"},
	{"pos": Vector3(-220.0, 0.0,-120.0),"name": "Lord of Darkness Lair",
	"kind": "boss",     "color": Color(0.20, 0.05, 0.30),   "icon": "☠",
	"asset": "Boss.glb"},
