...
- QA 2026-05-10T00:00Z: Build=None (no workflow conclusion — no recent completed run), §15: Hero.glb 29MiB > 20MiB soft cap — REFERENCED in Main.tscn+Player.gd+CharacterSelect.gd, cannot delete; already logged as tech debt. No new action taken.
